...
if [[ -e /home/aru/.config/systemd/user/rclone-archive.service || -e /home/aru/.config/systemd/user/rclone-sync.service || -e /home/aru/.config/systemd/user/rclone-sync.timer ]]; 
